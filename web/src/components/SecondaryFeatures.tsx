...
function DeviceOfflineIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
      ...
      />
      <path
        d="M16 14v4m0 4h.01M12 16a4 4 0 018 0"
        stroke="#EA580C"
        strokeWidth={2}
        strokeLinecap="round"
      />
  ...
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      ...
      <path
        ...
        fill="#737373"
      />
      <rect x={9} y={12} width={14} height={2} rx={1} fill="#EA580C" />
      <rect x={9} y={16} width={4} height={4} rx={1} fill="#737373" />
      <rect x={14} y={16} width={4} height={4} rx={1} fill="#737373" />
      <rect x={19} y={16} width={4} height={4} rx={1} fill="#737373" />
      <rect x={9} y={22} width={4} height={4} rx={1} fill="#737373" />
      <rect x={14} y={22} width={4} height={4} rx={1} fill="#EA580C" />
    </svg>
  )
}
...
function DeviceTargetIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      <circle cx={16} cy={16} r={16} fill="#A3A3A3" fillOpacity={0.2} />
      <path
        ...
        fill="#737373"
      />
      <circle cx={16} cy={20} r={6} stroke="#EA580C" strokeWidth={2} fill="none" />
      <circle cx={16} cy={20} r={3} stroke="#EA580C" strokeWidth={2} fill="none" />
      <circle cx={16} cy={20} r={1} fill="#EA580C" />
    </svg>
  )
}
  ...
  return (
    <svg viewBox="0 0 32 32" aria-hidden="true" {...props}>
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx={16} cy={22} r={1} fill="#EA580C" />
      <path
        d="M16 10l6 12H10l6-12z"
        stroke="#EA580C"
        strokeWidth={2}
        fill="none"
        strokeLinejoin="round"
