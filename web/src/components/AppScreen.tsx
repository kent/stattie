...
function BasketballIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      ...
      <path d="M12 2v20M2 12h20" stroke="#EA580C" strokeWidth="1.5" />
      <path d="M4.5 5.5c3 3.5 3 9.5 0 13M19.5 5.5c-3 3.5-3 9.5 0 13" stroke="#EA580C" strokeWidth="1.5" />
    </svg>
  )
}
  ...
  return (
    <div className={clsx('flex flex-col', className)} {...props}>
      <div className="flex justify-between px-4 pt-4">
        ...
        <BasketballIcon className="h-6 flex-none" />
